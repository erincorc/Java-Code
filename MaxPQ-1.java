...
public class MaxPQ<Key extends Comparable>{
  ...
  private void swim(Node z) {
   if (z != null && z.parent != null) {
    ...
    while (z.parent != null && (z.info.compareTo(z.parent.info) > 0)) {
      Node zParent = z.parent;
      tempHolder = z.info;
      z.info = zParent.info;
      zParent.info = tempHolder;
      z = zParent;
    }
  }
  }
...
private void printLevelOrder(Node root)
{
 ...
 // nodes of next level
  ...
  public static void main(String[] args){
    ...
    System.out.println("Size of PQ is: " + newPQ.size);
    ...
    System.out.println("Size of PQ is now: " + newPQ.size());
